...
from Name import Students ,Registration,Subjects,Teacher, session

app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI']='postgresql://webadmin:XBDqhh16389@10.104.9.223:5432/work'

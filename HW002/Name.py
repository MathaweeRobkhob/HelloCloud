...
engine = sqlalchemy.create_engine('postgresql://webadmin:XBDqhh16389@node37005-mathawee.proen.app.ruk-com.cloud:5432/work')
...
user2 = Students(
    student_id ='6406022610061',
    S_f_name='Mathawee',
    S_l_name='Robkhob',
    S_e_mail ='6406022610061@kmutnb.ac.th'
)

user1 = Students(
    student_id ='6406022610070',
    S_f_name='Rawiporn',
    S_l_name='Suamsiri',
    S_e_mail ='6406022610070@kmutnb.ac.th'
)

user3 = Students(
    student_id ='6406022620088',
    S_f_name='Puntita',
    S_l_name='Chungchawna',
